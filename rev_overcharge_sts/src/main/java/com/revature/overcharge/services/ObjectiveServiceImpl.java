...
public class ObjectiveServiceImpl implements ObjectiveService {
	...
	public void getAdd4CardsDaily(User u) {
		...
		if (progressPercentage > 100) {
			u.getObjectives().add(new Objective(name, pointsToAward, 100, countForGoal));
		} else {
			u.getObjectives().add(new Objective(name, pointsToAward, (int) progressPercentage, countForGoal));
		}
	...
	public void get5StarDeckWeekly(User u) {
		...
		if (matchedDeck == 1) {
			u.getObjectives().add(new Objective("Get a Five Star Rating on a Deck", 300, 100, 1));
		} else {
			u.getObjectives().add(new Objective("Get a Five Star Rating on a Deck", 300, 0, 1));
		}
	...
	public void getMarkAllCardsInDeckStudiedWeekly(User u) {
		...
		if (deckCompleted == 1) {
			u.getObjectives().add(new Objective("Mark All Cards in Two Sets as Studied", 300, 100, 1));
		} else {
			u.getObjectives().add(new Objective("Mark All Cards in Two Sets as Studied", 300, 0, 1));
		}
	...
	public void getMarkFiveCardsDaily(User u) {
		...
		if (studiedCardCount >= 5) {
			u.getObjectives().add(new Objective("Mark 5 Cards as Studied", 50, 100, 5));
		} else {
			u.getObjectives().add(new Objective("Mark 5 Cards as Studied", 50, (int) (studiedCardCount / 5.0 * 100), 5));
		}
